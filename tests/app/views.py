...
from tests.app.data import get_cities_list
from tests.app.data import get_city_object
...
from tests.app.serializers import CitySerializer
...
class ExplosiveViewSet(viewsets.ViewSet):
    def list(self, request):
        ...
        serializer = ExplosiveSerializer(
            explosives, many=True, context={"request": request}
        )
        response = Response(serializer.data)
        return response
